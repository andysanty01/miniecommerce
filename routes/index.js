...
const { getRoles, getRolesByID, postCreateRoles,putUpdateRoles, deleteRoles } = require("../controllers/role.controller");
...
const { getCart_dets, getDetallesByCarrito, postCreateCart_dets, putUpdateCart_dets, deleteCart_dets}=require("../controllers/cart_det.controller")
...
router.get("/cartDet/:id",getDetallesByCarrito)
